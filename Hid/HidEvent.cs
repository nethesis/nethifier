...
namespace SharpLib.Hid
{
    ...
    public class Event : IDisposable
    {
        ...
        /// </summary>
        /// <param name="aHandler">Handler creating this event, used to fetched cached devices</param>
        ...
        public Event(Handler aHandler, Message aMessage, HidEventRepeatDelegate aRepeatDelegate, bool aRepeat, int aRepeatDelayInMs=-1, int aRepeatSpeedInMs=-1 )
        {
            RepeatCount = 0;
            IsValid = false;
            IsKeyboard = false;
            ...
            try
            {
                ...
                if (RawInput.header.hDevice != IntPtr.Zero)
                {
                    ...
                    Device = aHandler.FetchDevice(RawInput.header.hDevice);                    
                }
